    ...
    <>
      ...
      <section className='relative'>
        ...
        <div
          ...
          <TitleSection 
            ...
            pill='Testimonials' 
            subheading='Join 10 of my friends who also use this application'
          />
      ...
      >
        <TitleSection 
            ...
            pill='Pricing' 
            subheading='This app is free for use but you can still send me money so that I can bet it all on stake.com'
          />
        <div
          className="flex 
        flex-col-reverse
